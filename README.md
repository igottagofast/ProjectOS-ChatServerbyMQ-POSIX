...
<img src=".\result\Screenshot 2025-11-05 113459.png" alt="Average Total Time">
 ...
 • ระบบได้ใช้ประโยชน์จาก multithreading ช่วงแรก แต่พอถึงจุดอิ่มตัว (overhead เริ่มมากขึ้น) ประสิทธิภาพจึงไม่ดีขึ้นอีก
...
<img src=".\result\Screenshot 2025-11-05 113507.png" alt="Average Latency">
 ...
 • มีการ optimize เล็กน้อยตอน multi-thread แต่ระบบยัง bound ด้วยความเร็วของ server มากกว่า client

---
<img src=".\result\Screenshot 2025-11-05 113515.png" alt="Average Throughput">


• Throughput เพิ่มขึ้นมากจาก 1 → 2 threads 

• แต่หลังจากนั้นแทบไม่เปลี่ยน (คงที่แถว 6.6 k msg/s)  แสดงถึง ระบบถึงจุดอิ่มตัวด้าน throughput ตั้งแต่ประมาณ 2–4 threads

• ถ้าเพิ่ม threads อีก overhead ของ context switching และ locking อาจเริ่มมีผล
